            ...
            if ($quizDataFile) {
                ...
                while (($quizData = fgetcsv($quizDataFile)) !== false) {
                    if (!empty ($quizData[1]) && $quizSelectionne == $quizData[1]) {
                        ...
                        echo "<h1>Titre du quiz : $titreQuiz</h1>";
                                    ...
                                    if ($reponsesFile) {
                                        ...
                                        while (($reponsesData = fgetcsv($reponsesFile)) !== false) {
                                            if ($reponsesData[0] === $titreQuiz && $reponsesData[1] === $questionsData[1]) {
                                                $i += 1;
                                                echo "<form action='' class='questionnaire' method='post'>";
                                                ...
                                                echo "<input type='hidden' name='bareme" . $i . "' value='{$questionsData[2]}'> La question vaux {$questionsData[2]} points <br>";
